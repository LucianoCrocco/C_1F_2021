		...
		switch(opcion){
			...
			case 6:
				validacion=comprobarEspaciosOcupadosEstructura(listadoDeProductos, LENGHT_PRODUCTOS);
					...
					break;
			case 7:
				//Mal hecha la funcion, solo puede retornar una. No se como hacer para retornar mas de 1 elemento sin devolver un array pero no recuerdo bien punteros.
				validacion=comprobarEspaciosOcupadosEstructura(listadoDeProductos, LENGHT_PRODUCTOS);
					if(validacion != -1){
						printMaximos(listadoDeProductos, LENGHT_PRODUCTOS);
					} else {
						printf("\n--------No hay productos cargados--------\n\n");
					}
				break;
			case 8:
				validacion=comprobarEspaciosOcupadosEstructura(listadoDeProductos, LENGHT_PRODUCTOS);
					if(validacion != -1){
						printPromediosPorTipo(listadoDeProductos, LENGHT_PRODUCTOS);
					} else {
						printf("\n--------No hay productos cargados--------\n\n");
					}
				break;
