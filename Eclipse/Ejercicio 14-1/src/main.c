...
#define LENGHT_FABRICANTE_PANTALLA 10
...
int main(void){
	...
	eFabricanteDePantalla listaDeFabricantesPantallas[LENGHT_FABRICANTE_PANTALLA];
	inicializarIsEmptyFabricante(listaDeFabricantesPantallas,LENGHT_FABRICANTE_PANTALLA);
	hardocodearDatosUnaStructFabricante(listaDeFabricantesPantallas);
