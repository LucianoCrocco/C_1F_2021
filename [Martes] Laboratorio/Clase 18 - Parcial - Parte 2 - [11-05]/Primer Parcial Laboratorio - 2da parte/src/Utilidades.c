...
int menu(void){
	...
	printf("7. Trabajos ordenados por marca\n");
	printf("8. El/los servicios mas realizados\n");
	printf("9. Listado de Servicios realizados con sus bicicletas\n");

	printf("10. Salir\n");
	opcionMenu=pedirEnteroConRango("Ingrese una opcion: ", "Error...Ingrese una opcion valida", 1, 10);
